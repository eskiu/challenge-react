...
function DownArrow() {
    return (
        <svg version="1.1" className='downarrow' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 20.633 20.633" style={{ enableBackground: "new 0 0 20.633 20.633" }} xmlSpace="preserve">
            <g>
